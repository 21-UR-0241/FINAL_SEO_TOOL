            ...
            <div className="block sm:hidden mb-6">
              ...
              <div className="relative">
                <select
                  ...
                  className="block w-full pl-4 pr-10 py-3 text-base border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-lg bg-white shadow-sm appearance-none cursor-pointer hover:border-gray-400 transition-colors"
                >
                  <option value="all">
            ...
            <div className="hidden sm:block border-b border-gray-200 mb-6">
              <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                ...
                <button
                  ...
                  `}
                >
                  <span className="inline-block">All Content</span>
                  <span className={`
...
<div
  key={item.id}
  className="border rounded-lg p-4 sm:p-6 hover:shadow-sm transition-shadow"
>
  {/* Content Section */}
  <div className="mb-4">
    <div className="flex-1 min-w-0">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-3">
        ...
        {item.niche && (
          <span className="inline-flex items-center px-2.5 py-1 sm:px-2 sm:py-0.5 rounded text-xs font-medium bg-indigo-100 text-indigo-700 whitespace-nowrap">
            <Target className="w-3 h-3 mr-1" />
      ...
      {/* Preview Text - Strip HTML to prevent image overflow */}
  ...
  {/* Metrics Grid */}
  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4 mb-4 pt-3 border-t">
    <div className="text-center">
      <div
  ...
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs text-gray-500 border-t pt-3 gap-2">
    <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
      ...
      {item.seoKeywords && item.seoKeywords.length > 0 && (
        <span className="w-full sm:w-auto">Keywords: {item.seoKeywords.join(", ")}</span>
      )}
      {item.eatCompliance && (
