    ...
    onSuccess: (data) => {
      ...
      if (hasValidScore) {
        ...
        toast({
          ...
          description: `${websiteName} analysis finished. ${scoreText} Found ${issueCount} issue(s) (${criticalIssues} critical)`,
        });
      } else {
  ...
  return (
    <div className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="mt-4 flex flex-col sm:flex-row md:mt-0 md:ml-4 gap-2 w-full sm:w-auto">
  {/* Fix with AI */}
              <Button
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-6">
              ...
              {fixResult?.stats?.detailedBreakdown && (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg">
            ...
            <div>
              ...
              <Tabs defaultValue="issues" className="space-y-6">
                <TabsList className="grid w-full grid-cols-2 h-auto">
                  <TabsTrigger value="issues" className="text-xs sm:text-sm px-2 sm:px-4 py-2">Issues & Fixes</TabsTrigger>
                  ...
                  <Card>
                    ...
                    <Tabs defaultValue="fixable" className="w-full">
                      <TabsList className="grid w-full grid-cols-3 h-auto">
                        <TabsTrigger value="fixable" className="text-xs sm:text-sm px-2 sm:px-3 py-2">
                          AI Fixable
                        </TabsTrigger>
                        <TabsTrigger value="manual" className="text-xs sm:text-sm px-2 sm:px-3 py-2">
                          Manual
                        </TabsTrigger>
                        <TabsTrigger value="resolved" className="text-xs sm:text-sm px-2 sm:px-3 py-2">
                          Resolved
                        </TabsTrigger>
                      </TabsList>
                      ...
                      <TabsContent value="fixable" className="space-y-4 mt-6">
                        {(() => {
                          ...
                          const activeFixableIssues = fixableIssues.filter(
                            (i) => !["fixed", "resolved"].includes(i.trackingStatus)
                          );
                          ...
                          return activeFixableIssues.map((issue, index) => {
                            ...
                            return (
                              <div
                                key={index}
                                className={`p-3 sm:p-4 rounded-lg border ${getIssueColor(
                                  issue.type
                                )} relative`}
                              >
                                {/* Status indicator - Mobile: top, Desktop: top-right */}
                                <div className="mb-3 sm:mb-0 sm:absolute sm:top-2 sm:right-2">
                                ...
                                <div className="flex flex-col space-y-3 sm:pr-20">
                                  <div className="flex items-start space-x-2 sm:space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      <div className="flex flex-wrap items-start gap-1.5 sm:gap-2 mb-2">
                                        <h4 className="font-medium text-sm sm:text-base break-words min-w-0 flex-1">
                                          {issue.title}
                                        </h4>
                                        <Badge
                                          variant="outline"
                                          className="text-xs bg-green-50 text-green-700 border-green-200 whitespace-nowrap flex-shrink-0"
                                        >
                                          <Zap className="w-3 h-3 mr-1" />
                                          AI Fixable
                                        </Badge>
                                      ...
                                      <p className="text-xs sm:text-sm mt-1 opacity-90 break-words overflow-wrap-anywhere">
                                        {issue.description}
                                      </p>

                                      {/* Tracking Details - Now wraps properly on mobile */}
                    ...
                    <TabsContent value="manual" className="space-y-4 mt-6">
                      {(() => {
                        ...
                        return manualIssues.map((issue, index) => (
                          <div
                            key={index}
                            className={`p-3 sm:p-4 rounded-lg border ${getIssueColor(issue.type)}`}
                          >
                              ...
                              <div className="flex items-start space-x-2 sm:space-x-3">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex flex-wrap items-start gap-1.5 sm:gap-2 mb-2">
                                    ...
                                    <Badge
                                      variant="outline"
                                      className="text-xs bg-orange-50 text-orange-700 border-orange-200 whitespace-nowrap flex-shrink-0"
                                    >
                      ...
                      {(() => {
                        ...
                        return resolvedIssues.map((issue, index) => {
                          ...
                          return (
                            <div
                              key={index}
                              className="p-3 sm:p-4 rounded-lg border border-green-200 bg-green-50"
                            >
                              <div className="flex flex-col space-y-3">
                                <div className="flex items-start space-x-2 sm:space-x-3">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    {/* Title and Badge */}
                                    <div className="flex flex-wrap items-start gap-1.5 sm:gap-2 mb-2">
                                      <h4 className="font-medium text-sm sm:text-base text-green-900 break-words min-w-0 flex-1">
                                        {issue.title}
                                      </h4>
                                      <Badge
                                    ...
                                    {/* Description */}
                                    <p className="text-xs sm:text-sm mt-1 text-green-800 opacity-90 break-words overflow-wrap-anywhere">
                                      {issue.description}
                                    </p>
