...
export function Pricing(): JSX.Element {
  ...
  const comparisonFeatures: ComparisonCategory[] = [
    {
      category: "WordPress Management",
      features: [
        { name: "WordPress sites", starter: "1", business: "5" },
        { name: "Content health monitoring", starter: "Manual", business: "Automated" },
        { name: "Bulk operations", starter: false, business: true },
        { name: "Multi-site dashboard", starter: false, business: true },
      ],
    },
    {
      category: "AI Content Optimization",
      features: [
        { name: "AI optimizations/month", starter: "20", business: "200" },
        { name: "Readability improvements", starter: true, business: true },
        { name: "Automated content fixes", starter: false, business: true },
        { name: "Custom AI prompts", starter: false, business: true },
      ],
    },
    {
      category: "SEO & Analytics",
      features: [
        { name: "SEO analysis", starter: "Basic", business: "Advanced" },
        { name: "SEO recommendations", starter: "Manual", business: "Automated" },
        { name: "Content performance tracking", starter: false, business: true },
        { name: "Advanced analytics", starter: false, business: true },
      ],
    },
    {
      category: "Automation & Integration",
      features: [
        { name: "Automated workflows", starter: false, business: "Basic" },
        { name: "API access", starter: false, business: "5K calls/mo" },
        { name: "Webhooks", starter: false, business: true },
      ],
    },
    {
      category: "Team & Support",
      features: [
        { name: "Team members", starter: "1", business: "5" },
  ...
  const faqs: FAQ[] = [
    ...
    {
      question: "What happens if I exceed my monthly AI optimization limit?",
      answer: "On the Starter plan, you'll need to upgrade or wait until next month. Business users can purchase additional optimization packs at discounted rates.",
    },
    {
      question: "Do you offer a free trial?",
      answer: "Yes! The Business plan includes a 14-day free trial with full access to features. No credit card required to start your trial.",
    },
    {
      question: "How does the WordPress site limit work?",
      answer: "You can connect up to the number of WordPress sites allowed by your plan. Each site can be managed independently with its own settings and optimization queue.",
    ...
    {
      question: "What AI models do you use?",
      answer: "We use state-of-the-art language models (including GPT-4, Claude, and Gemini) optimized for content quality, readability, and SEO.",
    },
    {
      question: "Is my WordPress content secure?",
      answer: "Absolutely. We use enterprise-grade encryption for all data in transit and at rest. We never store your WordPress credentials, only secure API tokens. Your content is processed securely and never used for AI training.",
                ...
                <table className="w-full min-w-[640px]">
                  ...
                  <tbody>
                    {comparisonFeatures.map((category, catIndex) => (
                      <React.Fragment key={catIndex}>
                        <tr className="bg-white/[0.02]">
                          <td colSpan={3} className="p-4 text-blue-300 font-bold text-sm uppercase tracking-wider">
                            {category.category}
                          </td>
                        </tr>
                        {category.features.map((feature, featIndex) => (
