    ...
    <div className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="mt-4 flex flex-col sm:flex-row gap-2 md:mt-0 md:ml-4 w-full sm:w-auto">
          {isSelectionMode ? (
            <>
              <Button variant="outline" onClick={handleCancelSelection} className="w-full sm:w-auto">
                Cancel
              </Button>
                <AlertDialog>
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Delete Selected ({selectedReports.size})</span>
                    <span className="sm:hidden">Delete ({selectedReports.size})</span>
                  </Button>
                  </AlertDialogTrigger>
                  <AlertDialogContent>
                    <AlertDialogHeader>
                ...
                <>
                  ...
                  <Button
                    ...
                    className="w-full sm:w-auto bg-primary-500 hover:bg-primary-600 text-white disabled:opacity-50 disabled:cursor-not-allowed"
                  title={
                    reportType === "all"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-4 pt-4 border-t gap-3">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        ...
                        {/* PDF */}
                          ...
                          size="sm"
                          variant="outline"
                          className="text-primary-600 flex-1 sm:flex-initial"
            ...
            <CardContent className="text-center py-12">
              ...
              <div className="mt-6">
                  <Button
                    onClick={handleBulkGenerate}
                    disabled={isGenerateDisabled}
                    className="w-full sm:w-auto bg-primary-500 hover:bg-primary-600 disabled:opacity-50"
                  >
                  {isAnyOperationInProgress ? (
                    <>
                      <RefreshCw className="w-4 h-4 mr-2 animate-spin" />
