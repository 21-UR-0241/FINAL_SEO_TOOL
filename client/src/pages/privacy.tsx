...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Information We Collect</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none space-y-4">
//                       <div>
//                         <h4 className="text-lg font-bold text-white mb-2">Personal Information</h4>
...
//                       </div>
//                       <div>
//                         <h4 className="text-lg font-bold text-white mb-2">Automatically Collected Information</h4>
//                         <p className="text-gray-300 leading-relaxed mb-2">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">How We Use Information</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Information Sharing</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Data Security</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Cookies & Tracking Technologies</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </p>
//                       <div>
//                         <h4 className="text-lg font-bold text-white mb-2">Types of Cookies We Use:</h4>
//                         <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Your Privacy Rights</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                         To exercise these rights, please contact us at <a href="mailto:privacy@wpaimanager.com" className="text-blue-400 hover:text-blue-300">privacy@wpaimanager.com</a>
//                       </p>
//                     </div>
//                   </div>
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Data Retention</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">International Data Transfers</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Children's Privacy</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
...
//                       </div>
//                       <h3 className="text-2xl font-black text-white">Changes to This Privacy Policy</h3>
//                     </div>
//                     <div className="prose prose-invert max-w-none">
//                       <p className="text-gray-300 leading-relaxed mb-4">
