    ...
    <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6 sm:mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{stats?.users || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{stats?.websites || 0}</div>
            <p className="text-xs text-muted-foreground">
              Active sites
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">{stats?.content || 0}</div>
            <p className="text-xs text-muted-foreground">
              Total posts
            </p>
          </CardContent>
      ...
      <div className="md:hidden mb-6">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="api-usage">
              <div className="flex items-center">
                <Activity className="w-4 h-4 mr-2" />
                System API Usage
              </div>
            </SelectItem>
            <SelectItem value="user-api-usage">
              <div className="flex items-center">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="hidden md:grid md:grid-cols-3 w-full">
          ...
          <TabsTrigger value="api-usage" className="text-sm">
            System API Usage
          </TabsTrigger>
          <TabsTrigger value="user-api-usage" className="text-sm">
            User API Usage
          </TabsTrigger>
        </TabsList>
                    ...
                    <TableBody>
                      {users.map((user) => (
                        <TableRow key={user.id}>
                          ...
                          <TableCell className="text-xs sm:text-sm">{user.email || 'N/A'}</TableCell>
                          <TableCell>
                            <Badge variant={user.isAdmin ? "default" : "secondary"} className="text-xs whitespace-nowrap">
        ...
        <TabsContent value="api-usage">
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base sm:text-lg">System API Keys Status</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
                  ...
                  {apiUsage?.systemKeysStatus && Object.entries(apiUsage.systemKeysStatus).map(([key, configured]) => (
                    <div key={key} className="flex items-center justify-between p-3 sm:p-4 border rounded-lg">
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <Key className={`h-4 w-4 flex-shrink-0 ${configured ? 'text-green-500' : 'text-gray-400'}`} />
                        <span className="text-xs sm:text-sm font-medium capitalize truncate">
                          {key.replace(/([A-Z])/g, ' $1').trim()}
                        </span>
                      </div>
                      <Badge variant={configured ? "default" : "secondary"} className="text-xs whitespace-nowrap ml-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base sm:text-lg">Usage by AI Provider</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="text-xs sm:text-sm">Requests</TableHead>
                          <TableHead className="text-xs sm:text-sm">Tokens Used</TableHead>
                      ...
                      <TableBody>
                        {apiUsage?.providerCosts && Object.entries(apiUsage.providerCosts).map(([provider, data]: [string, any]) => (
                          <TableRow key={provider}>
                            <TableCell className="font-medium capitalize text-xs sm:text-sm">{provider}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatNumber(data.requests)}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatNumber(data.tokens)}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatCost(data.costCents)}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base sm:text-lg">Detailed Usage Breakdown</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="text-xs sm:text-sm">Requests</TableHead>
                          <TableHead className="text-xs sm:text-sm">Tokens</TableHead>
                          <TableHead className="text-xs sm:text-sm">Cost</TableHead>
                          <TableHead className="text-xs sm:text-sm">Last Used</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {apiUsage?.usageByModel?.map((usage: any, idx: number) => (
                          <TableRow key={idx}>
                            <TableCell className="font-medium text-xs sm:text-sm">{usage.model}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{usage.operation}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{usage.usageCount}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatNumber(usage.totalTokens)}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatCost(usage.totalCostCents)}</TableCell>
                            <TableCell className="text-xs sm:text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base sm:text-lg">Recent Daily Usage</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
                      ...
                      <TableBody>
                        {apiUsage?.dailyUsage?.slice(0, 7).map((day: any, idx: number) => (
                          <TableRow key={idx}>
                            ...
                            <TableCell className="text-xs sm:text-sm">{day.requests}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatNumber(day.totalTokens)}</TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatCost(day.totalCostCents)}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
        ...
        <TabsContent value="user-api-usage">
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div>
                    <CardTitle className="text-base sm:text-lg">API Usage by User</CardTitle>
                    <CardDescription className="text-xs sm:text-sm">
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="text-xs sm:text-sm">Email</TableHead>
                          <TableHead className="text-xs sm:text-sm">Total Requests</TableHead>
                          <TableHead className="text-xs sm:text-sm">Tokens Used</TableHead>
                          ...
                          <TableRow key={user.userId}>
                            ...
                            <TableCell>
                              <div className="space-y-1">
                                <div className="text-xs sm:text-sm">{formatNumber(user.requestCount)}</div>
                                {user.userKeyRequests > 0 && (
                                  <div className="flex items-center gap-1">
                                    <Badge variant="outline" className="text-xs">
                                      <Key className="w-3 h-3 mr-1" />
                                      {formatNumber(user.userKeyRequests)}
                                    </Badge>
                                  </div>
                                )}
                                {user.systemKeyRequests > 0 && (
                                  <div className="flex items-center gap-1">
                                    <Badge variant="secondary" className="text-xs">
                                      ...
                                      {formatNumber(user.systemKeyRequests)}
                                    </Badge>
                                  </div>
                                )}
                              </div>
                            </TableCell>
                            <TableCell className="text-xs sm:text-sm">{formatNumber(user.totalTokens)}</TableCell>
                            <TableCell>
                              <div className="space-y-1">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base sm:text-lg">Current Month Usage by User</CardTitle>
                <CardDescription className="text-xs sm:text-sm">
                  ...
                  <div className="inline-block min-w-full align-middle">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="text-xs sm:text-sm">User</TableHead>
                          <TableHead className="text-xs sm:text-sm">Monthly Requests</TableHead>
                          <TableHead className="text-xs sm:text-sm">Monthly Tokens</TableHead>
                          <TableHead className="text-xs sm:text-sm">Monthly Cost</TableHead>
                          <TableHead className="text-xs sm:text-sm">% of Total</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {userApiUsage?.monthlyUserUsage?.map((user: any) => {
                          ...
                          return (
                            <TableRow key={user.userId}>
                              ...
                              <TableCell>
                                <div className="space-y-1">
                                  <div className="text-xs sm:text-sm">{formatNumber(user.monthlyRequests)}</div>
                                  <div className="flex flex-wrap gap-2">
                              ...
                              <TableCell className="text-xs sm:text-sm">{formatNumber(user.monthlyTokens)}</TableCell>
                              <TableCell>
                                <div className="space-y-1">
                                  <div className="font-semibold text-xs sm:text-sm">
                              ...
                              <TableCell>
                                <div className="flex items-center gap-2">
                                  ...
                                  />
                                  <span className="text-xs sm:text-sm whitespace-nowrap">{percentage}%</span>
                                </div>
                              </TableCell>
                            </TableRow>
                          );
      ...
      <Dialog open={!!selectedUserId} onOpenChange={() => setSelectedUserId(null)}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-base sm:text-lg">User API Usage Details</DialogTitle>
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            ...
                            <TableHead className="text-xs">Key Source</TableHead>
                        ...
                        <TableBody>
                          {selectedUserDetails.modelUsage?.map((model: any, idx: number) => (
                            <TableRow key={idx}>
                              ...
                              <TableCell className="text-xs">{model.requests}</TableCell>
                              <TableCell className="text-xs">{formatNumber(model.tokens)}</TableCell>
                              <TableCell className="text-xs">{formatCost(model.costCents)}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
                      ...
                      <Table>
                        ...
                        <TableBody>
                          {selectedUserDetails.operationUsage?.map((op: any, idx: number) => (
                            <TableRow key={idx}>
                              <TableCell className="text-xs">{op.operation}</TableCell>
                              <TableCell>
                              ...
                              <TableCell className="text-xs">{op.requests}</TableCell>
                              <TableCell className="text-xs">{formatNumber(op.tokens)}</TableCell>
                              <TableCell className="text-xs">{formatCost(op.costCents)}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
