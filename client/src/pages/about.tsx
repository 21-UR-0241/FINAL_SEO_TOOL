          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="relative group" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 md:p-6 hover:border-white/20 transition-all duration-300 text-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-black mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                <Link href="/pricing">
                  <Button className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-xl">
                    View Pricing
                  </Button>
                </Link>
              </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 md:p-8">
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base md:text-lg font-bold text-white mb-2">Our Goal</h4>
                      <p className="text-gray-400 text-xs md:text-sm">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-base md:text-lg font-bold text-white mb-2">Our Commitment</h4>
                      <p className="text-gray-400 text-xs md:text-sm">
            ...
            {values.map((value, index) => (
              <div key={index} className="group relative" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8 hover:border-white/20 transition-all duration-300 h-full">
                  <div
                    className={`w-12 h-12 md:w-14 md:h-14 rounded-xl bg-gradient-to-br ${value.gradient} flex items-center justify-center mb-4 md:mb-6 shadow-lg flex-shrink-0`}
                  >
                    <div className="text-white">{value.icon}</div>
                  </div>
                  <h4 className="text-lg md:text-xl font-bold text-white mb-3">{value.title}</h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {team.map((member, index) => (
              <div key={index} className="group relative" style={{ animationDelay: `${index * 100}ms` }}>
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl blur-xl group-hover:blur-2xl transition-all"></div>
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8 hover:border-white/20 transition-all duration-300 text-center">
                  <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 text-xl md:text-2xl font-black text-white shadow-lg">
                    {member.image}
                  </div>

                  <h4 className="text-lg md:text-xl font-bold text-white mb-1">{member.name}</h4>
                  <p className="text-blue-400 text-xs md:text-sm font-medium mb-3">{member.role}</p>
                  <p className="text-gray-400 text-xs md:text-sm mb-4">{member.bio}</p>

                  {/* FIXED: missing <a> tags here */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <Link href="/pricing">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-2xl text-base font-bold px-8 py-6"
                    >
                      View Pricing
                    </Button>
                  </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            <div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">AI-powered content optimization for WordPress sites.</p>
            </div>
