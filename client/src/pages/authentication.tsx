...
function GoogleOAuthButton() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      console.log('🔍 Fetching Google OAuth URL from:', `${API_BASE_URL}/api/auth/google/url`);
      ...
      if (!response.ok) {
        ...
        console.error('❌ Google OAuth URL error:', errorData);
      ...
      if (data.success && data.url) {
        ...
        const errorMsg = data.message || "No OAuth URL received from server";
        console.error('❌ Invalid response:', data);
        throw new Error(errorMsg);
      }
    } catch (error: any) {
      console.error("❌ Google OAuth error:", error);
      const errorMessage = error.message || "Failed to connect with Google. Please try again.";
